...
ADMIN = {'настройка','панель','заявки','проверить','роли_настроить','автороли','события','событие','сундук_события','автопосты','автопост_статус','автопост_сейчас','босс_настройка','босс_призвать'}
GAMES = {'викторина','дуэль','экспедиция','предсказание','сундуки','угадай','рыбалка','лабиринт','босс'}
